...
public class Agente extends Entidade {
    ...
    public void mover() {
        ...
        if(caminhada>0) {
            ...
            if (caminhada == 0) {
                if(caminho.isEmpty()){
                    setEstado(estado.PARAR);   
                    return;
                }
                direcao = (enumDirecao) getCaminho().pop();
                if(direcao==null) setEstado(estado.PARAR);
     ...
     */
    public void setCaminho(Stack caminho) {
