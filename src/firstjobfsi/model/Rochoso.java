...
public class Rochoso extends Terreno{
    ...
    public Rochoso(Rectangle retangulo, boolean legendado, boolean informado) {
        ...
        setImage(sheet.grabImage(7, 2, retangulo.width, retangulo.height));    
        setLegenda(new TextoTela("Rochoso: " + getG(), new Point(retangulo.getLocation().x,retangulo.y+retangulo.height-30), Color.red));
